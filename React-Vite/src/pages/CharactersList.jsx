        ...
        <Col key={char.id} sm={6} md={4} lg={3}>
          <Card className="mb-4">
            ...
            <Card.Body>
              ...
              <Card.Text>
                {char.powers?.length > 100
                  ? char.powers.slice(0, 100) + '...'
                  : char.powers}
              </Card.Text>
              <Link to={`/characters/${char.id}`} className="btn btn-outline-primary me-2">
                View Details
              </Link>
              <Link to={`/characters/${char.id}/edit`} className="btn btn-outline-warning">
                Edit
              </Link>
            </Card.Body>
          </Card>
